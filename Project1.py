...
def cargar_recursos(archivo="Project Pro 1/Recursos.json"):
    try:
...
class Planificador:
    def __init__(self,archivo_eventos="Project Pro 1/Eventos.json",archivo_recursos="Project Pro 1/Recursos.json"):
